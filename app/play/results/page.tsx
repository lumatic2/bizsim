  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div>
          <h3 className="text-sm font-semibold mb-3">세그먼트별 판매량</h3>
        ...
        <div>
          <h3 className="text-sm font-semibold mb-3">판매 요약</h3>
          <div className="border border-gray-200 rounded-lg p-4 bg-white text-sm space-y-2">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
        <h3 className="text-sm font-semibold mb-2">AI 디브리프</h3>

...
export default function FinancialsPage() {
  ...
  const pnlRows = [
    ...
    { label: '인건비 (영업·R&D)', value: -pnl.laborCost },
    { label: '설비유지비', value: -pnl.maintenanceCost },
    { label: '서비스 opex', value: -pnl.serviceCost },
    { label: '재고유지비', value: -pnl.inventoryHoldingCost },
    { label: '일반관리비', value: -(pnl.otherExpense - pnl.laborCost - pnl.maintenanceCost - pnl.serviceCost - pnl.inventoryHoldingCost) },
